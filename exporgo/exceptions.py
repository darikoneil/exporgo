...
class InvalidFilenameError(ValueError):
    ...
    def __init__(self, key: str, filename: str | Path):
        ...
        super().__init__(
            f"Argument {self.key} has invalid filename {self.filename}."
...
class InvalidExtensionWarning(UserWarning):
    ...
    def __init__(
        ...
        super().__init__(
            f"Argument {self.key} has invalid file extension {self.extension}. "
...
class DuplicateExperimentError(ValueError):
    ...
    def __init__(self, alias: str):
        super().__init__(
            f"{alias} is already registered. Consider using a different name."
        )
...
class DuplicateRegistrationError(ValueError):
    ...
    def __init__(self, alias: str):
        super().__init__(
            f"{alias} is already registered. Consider using a different name or "
...
def _config_mismatch_message(version: str) -> str:
    ...
    """
    return (
        f"Imported organization was not saved with the current version of "
...
class VersionBackwardCompatibilityWarning(UserWarning):
    ...
    def __init__(self, version: str):
        super().__init__(
            f"{_config_mismatch_message(version)} "
